  ...
  function showBookDetails(book) {
    ...
    modal.innerHTML = `
      ...
      book.title
                ...
                <div class="flex gap-7 justify-between items-start mb-4">
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex justify-between items-center">
                              ...
                              }"><img src="./img/amazon-shop.png" alt="amazon-shop"></a>
                              <a href=""><img src="./img/apple-shop.png" alt="apple-shop"></a>
                              <a href=""><img src="./img/bookshop.png" alt="bookshop"></a>
                ...
                <button class="w-full p-2 rounded-full mt-4 border border-green-500 hover:bg-green-500 hover:text-white font-bold text-xl">ADD TO SHOPPING LIST</button>
            </div>
